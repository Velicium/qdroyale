...
import { LinkedInIcon, TwitterIcon, InstagramIcon, SunIcon, MoonIcon } from './Icons';
...

        {
            ...
            '>
                <nav className='flex items-center flex-col justify-center'>
                    ...
                    <CustomMobileLink href="#programs" title="Jewelry" className='text-primaryDark dark:text-primary' toggle={handleClick} />
                </nav>
