...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors:{
        dark: "#1b2b3b", // royale Dark
        light: "#e4f4f4", // royale Light
        primary: "#F6CD46", //  - royale Yellow
        royaleYellowDark: "#F6CD46", //  - royale Yellow
        primaryDark: "#843FC5", // royale Purple
        royaleGreen: "#45f383", // royale Green
        royaleGreenDark: "#09C64F", // royale Green Dark
        royaleYellow: "#FFDE69", //  - royale Yellow
        royaleYellowDark: "#E2B136", //  - royale Yellow
      },
      animation: {
